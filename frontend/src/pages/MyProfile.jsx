...
export default function MyProfile() {
  ...
  const inputClass =
    "h-11 rounded-lg border-gray-200 bg-white focus:ring-2 focus:ring-[#1e3a5f]/10 focus:border-[#1e3a5f]";
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#faf8f5] via-white to-[#f5f0ea] pt-24 pb-12">
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="lg:w-72 shrink-0">
                  <div className="bg-white rounded-3xl shadow-xl shadow-[#1e3a5f]/10 p-6 text-center">
                    ...
                    <p className="text-sm text-gray-500 mt-2">
                      Welcome to your VisaMate profile. Update your information
            ...
            {activeSection === "additional_info" && (
              ...
              >
                <div className="bg-white rounded-3xl shadow-xl shadow-[#1e3a5f]/10 p-6">
                  ...
                  <p className="text-sm text-gray-500 mb-6">
                    Provide extra details to speed up your applications
                  </p>
            ...
            {activeSection === "documents" && (
              ...
              >
                ...
                <div className="bg-white rounded-3xl shadow-xl shadow-[#1e3a5f]/10 p-6">
                  ...
                  <p className="text-sm text-gray-500 mb-6">
                    Upload important documents like passport, ID, or
                    certificates
                  </p>
                  ...
                  {docsLoading ? (
                    ...
                    <div className="space-y-3">
                      {documents.map((doc) => (
                        <div
                          key={doc.id}
                          className="flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:border-[#1e3a5f]/20 transition-colors"
                        >
          ...
          {/* closes flex-1 min-w-0 main content */}
        </div>{" "}
        {/* closes flex flex-col lg:flex-row gap-8 */}
      </div>{" "}
      {/* closes container mx-auto */}
    </div>
  );
}
