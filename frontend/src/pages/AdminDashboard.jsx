                ...
                <CardContent>
                  <div className="space-y-3">
                    {messages.slice(0, 5).map((msg) => (
                      <div
                        key={msg.id}
                        className={`p-3 rounded-lg ${msg.is_read ? "bg-gray-50" : "bg-blue-50 border-l-4 border-blue-500"}`}
                      >
                        <div className="flex items-center justify-between">
                      ...
                      {appointments.map((apt) => (
                        <tr key={apt.id} className="border-b hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4">
                            ...
                            >
                              <SelectTrigger
                                className={`w-32 ${statusColors[apt.status]}`}
                              >
                                <SelectValue />
                              </SelectTrigger>
                              <SelectContent>
                          ...
                          <td className="py-3 px-4">
                            <Select
                              ...
                              onValueChange={async (newStatus) => {
                                try {
                                  await adminApi.updateApplicantStatus(app.id, {
                                    status: newStatus,
                                  });
                            ...
                            >
                              ...
                              <SelectContent>
                                ...
                                <SelectItem value="visa_processing">
                                  Visa Processing
                                </SelectItem>
          ...
          <form onSubmit={handleCreateSlot} className="space-y-4">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setNewSlot({ ...newSlot, service_type: value })
                }
              >
                <SelectTrigger>
                  <SelectValue />
